...
class SoftIF2D_channel_thresholds(Layer):
    ...
    def reset_variables(self, batch_size:int):
        ...
        # self.threshold = self.threshold[0].expand(batch_size,self.threshold[0].shape[0],self.threshold[0].shape[1],self.threshold[0].shape[2], device=self.threshold.device)
