...
def clock_driven_based_app(opt):
    print(opt)
    from n3ml.population import LIF1d
    ...
    if1d_pop = LIF1d(neurons=opt.n_neurons, v_th= opt.v_th, tau_ref=opt.ref, tau_rc=opt.decay, reset=opt.resting, rest=opt.resting)
