...
def clock_driven_based_app(opt):
    print(opt)
    from n3ml.population import CUBA_LIF1d
    ...
    if1d_pop = CUBA_LIF1d(neurons=opt.n_neurons, v_th= opt.v_th, tau_ref=opt.ref, tau_rc=opt.decay, reset=opt.resting, rest=opt.resting, q=opt.q)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--decay', default=10, type=int)
    ...
    parser.add_argument('--q', default=1.5, type=int)
